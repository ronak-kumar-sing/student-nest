...
import { CheckCircle, ArrowRight, Users, Search, MessageSquare, Star } from "lucide-react";
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-br from-[#1a1a1b] to-[#2a2a2b] border border-[#3a3a3b] rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-3 bg-gradient-to-r from-[#7c3aed] to-[#3b82f6] text-white font-semibold rounded-xl hover:from-[#6d28d9] hover:to-[#2563eb] transition-all duration-300 shadow-lg hover:shadow-xl">
                Find Accommodation
              </button>
              <button className="px-8 py-3 border border-[#3a3a3b] bg-[#1a1a1b] text-white font-semibold rounded-xl hover:bg-[#2a2a2b] transition-all duration-300">
                List Your Property
              </button>
            </div>
          </div>
