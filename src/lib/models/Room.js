...
const roomSchema = new mongoose.Schema({
  ...
  amenities: [{
    type: String,
    enum: ['wifi', 'ac', 'powerBackup', 'security', 'housekeeping', 'laundry', 'parking', 'gym', 'library', 'cafeteria', 'cctv', 'geyser', 'cooler', 'fridge', 'tv', 'bed', 'wardrobe', 'study_table', 'chair']
  }],
  detailedAmenities: [{
    type: String
  }],
